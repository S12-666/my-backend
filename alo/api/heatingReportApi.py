...
from ..controller.HeatingReportController import HeatingReportController
from . import api
...
class GetHeatingReportApi(Resource):
    def post(self):
        try:
        ...
        try:
            report_ctrl = HeatingReportController(para)
            res = report_ctrl.run()
...
api.add_resource(GetHeatingReportApi, '/v1.0/pidas/getHeatingReport')