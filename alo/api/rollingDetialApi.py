...
from ..controller.RollingDetialController import RollingDetialController
from . import api
...
class GetRollingDetialApi(Resource):
    def post(self):
        try:
        ...
        try:
            detial_ctrl = RollingDetialController(para)
            res = detial_ctrl.run()
...
api.add_resource(GetRollingDetialApi, '/v1.0/pidas/getRollingDetial')