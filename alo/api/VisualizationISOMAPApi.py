...
class CateVisualizationISOMAP(Resource):
    def post(self, startTime, endTime, limition):
        ...
        json = visualizationISOMAP.cate_run(data, data_1, data_2)
...
api.add_resource(CateVisualizationISOMAP, '/v1.0/model/CateVisualizationISOMAP/<startTime>/<endTime>/<limition>')
