...
from ..controller.GetBatchDataController import GetBatchDataController
from . import api
...
class GetBatchDataApi(Resource):
    def post(self):
        try:
        ...
        try:
            detial = GetBatchDataController(para)
            res = detial.run()
...
api.add_resource(GetBatchDataApi, '/v1.0/visual/getganttdata')