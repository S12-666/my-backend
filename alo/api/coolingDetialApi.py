...
from ..controller.CoolingDetialController import CoolingDetialController
from . import api
...
class GetCoolingDetialApi(Resource):
    def post(self):
        try:
        ...
        try:
            detial_ctrl = CoolingDetialController(para)
            res = detial_ctrl.run()
...
api.add_resource(GetCoolingDetialApi, '/v1.0/pidas/getCoolingDetial')