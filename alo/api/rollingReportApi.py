...
from ..controller.RollingReportController import RollingReportController
from . import api
...
class GetRollingReportApi(Resource):
    def post(self):
        try:
        ...
        try:
            report_ctrl = RollingReportController(para)
            res = report_ctrl.run()
...
api.add_resource(GetRollingReportApi, '/v1.0/pidas/getRollingReport')