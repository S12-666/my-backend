...
from ..controller.FQCReportController import FQCReportController
from . import api
...
class GetFQCReportApi(Resource):
    def post(self):
        try:
        ...
        try:
            report_ctrl = FQCReportController(para)
            res = report_ctrl.run()
...
api.add_resource(GetFQCReportApi, '/v1.0/pidas/getFQCReport')